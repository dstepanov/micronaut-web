// Source-level fixes for shapes that synced upstream docs are known to contain
// and that Asciidoctor would otherwise parse the wrong way. Applied by the docs
// preprocessor before parsing.

export function rewriteDocsSource(source: string): string {
