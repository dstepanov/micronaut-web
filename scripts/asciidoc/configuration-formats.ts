// Converts a YAML configuration example into every configuration format the
// docs offer as tabs. Invalid YAML is shown verbatim in each tab rather than
// failing the render.
...
export function configurationSamples(source: string): ConfigurationSample[] {
