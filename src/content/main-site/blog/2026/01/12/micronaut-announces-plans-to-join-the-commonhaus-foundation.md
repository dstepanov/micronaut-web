---
slug: 2026/01/12/micronaut-announces-plans-to-join-the-commonhaus-foundation
title: Micronaut Announces Plans to Join the Commonhaus Foundation
description: Today, we are announcing that the Micronaut framework is applying to join the Commonhaus Foundation. This is an exciting new step in the Micronaut project’s journey, and we’re looking forward to the opportunity to continue innovating with our community under the Commonhaus Foundation banner. As is customary at the turn of a new year, we’d...
date: '2026-01-12T17:31:10'
modified: '2026-01-12T17:33:31'
sourceUrl: https://micronaut.io/2026/01/12/micronaut-announces-plans-to-join-the-commonhaus-foundation/
wordpressId: 7407
...
The Micronaut framework was first conceived at [Object Computing](https://objectcomputing.com/) in 2017 at a time when runtime environments were evolving in a way that made utilizing existing JVM frameworks difficult. Innovations in Cloud runtime options aimed towards enabling microservice architecture designs and a growing emphasis on IIoT/Edge Computing favored technologies with fast startup times, and low resource consumption. Graeme Rocher, the creator of [Grails](https://grails.apache.org/), began to envision new approaches to building software for the JVM which maintain the developer and productivity-friendly features in existing tools like Spring and Jakarta EE but also introduce runtime-efficient innovations like ahead-of-time compilation as well as cloud-native integration features including first-class support for serverless computing.

We [open-sourced and released the first version of Micronaut](https://micronaut.io/2018/05/23/micronaut-open-sourced/) in 2018 to an ecosystem that was ready for innovation and change, and an enthusiastic and supportive community quickly formed. In 2020, we recognized a growing need to balance the interests from the Micronaut community and contributing organizations and [established the Micronaut Foundation](https://objectcomputing.com/how-we-share/news1/2020/06/29/micronaut-foundation-established) as a non-profit organization dedicated to ensuring technical innovation and advancement of the Micronaut framework as a free and open public-use software development toolkit for a growing global community. In 2023, the Foundation was further strengthened via a partnership with the [Unity Foundation](https://micronaut.io/2023/03/17/announcing-partnership-with-unity/).

Since its introduction, the framework has been widely successful. It is in active use by [large](https://aws.amazon.com/blogs/opensource/improving-developer-productivity-at-disney-with-serverless-and-open-source/) corporations, small companies, and private individuals alike, and has welcomed more than 900 community contributors to the project. [Oracle supports the project as an engineering partner](https://micronaut.io/2022/10/04/announcing-our-new-engineering-partner-oracle/), while other companies, such as [HiveMQ](https://www.hivemq.com/), [Microstream](https://microstream.one/), [Safri.Net](http://safri.net/), and [Vizor](https://vizor-games.com/games), have provided financial support for the project.
