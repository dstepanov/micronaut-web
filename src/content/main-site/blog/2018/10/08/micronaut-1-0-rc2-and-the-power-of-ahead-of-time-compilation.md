---
slug: 2018/10/08/micronaut-1-0-rc2-and-the-power-of-ahead-of-time-compilation
title: Micronaut 1.0 RC2 and the Power of Ahead-of-Time Compilation
description: Micronaut 1.0.0. RC2 release announcement
date: '2018-10-08T12:48:29'
modified: '2021-08-02T18:03:41'
sourceUrl: https://micronaut.io/2018/10/08/micronaut-1-0-rc2-and-the-power-of-ahead-of-time-compilation/
wordpressId: 2924
...
tags:
  - release
href: /2018/10/08/micronaut-1-0-rc2-and-the-power-of-ahead-of-time-compilation/
---
...
This second RC presents a further opportunity to test Micronaut and provide feedback as we build up to the GA release, which is scheduled for the 23rd of October – just in time for [Oracle Code One 2018](https://objectcomputing.com/index.php?cID=1336) in San Francisco where I will be [presenting on Micronaut](https://oracle.rainfocus.com/widget/oracle/oow18/catalogcodeone18?search=Micronaut)!

In addition, if you’re in Europe, and San Francisco is little far, consider attending [Voxxed Days Paris](https://objectcomputing.com/index.php?cID=1343), where I will be [presenting Micronaut on the 30th of October](https://voxxeddays.com/microservices/2018/10/05/graeme-rocher-on-micronaut/).
...
- Easier compatibility with GraalVM – although proxies are possible on GraalVM native image, these have to be [configured ahead of time](https://github.com/oracle/graal/blob/master/docs/reference-manual/native-image/DynamicProxy.md).
