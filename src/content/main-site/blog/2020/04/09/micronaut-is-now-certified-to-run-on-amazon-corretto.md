---
slug: 2020/04/09/micronaut-is-now-certified-to-run-on-amazon-corretto
...
date: '2020-04-09T12:49:12'
modified: '2021-02-19T17:17:31'
sourceUrl: https://micronaut.io/2020/04/09/micronaut-is-now-certified-to-run-on-amazon-corretto/
wordpressId: 2992
...
tags:
  - aws
  - corretto
href: /2020/04/09/micronaut-is-now-certified-to-run-on-amazon-corretto/
---

One practice used by the [Micronaut development team](https://objectcomputing.com/products/2gm-team) is continuous integration (CI). In support of this, the [Micronaut framework](https://micronaut.io/)‘s core has an extensive test suite executed via [GitHub Actions](https://github.com/features/actions), and since the beginning of 2020, tests have also been executed with [Amazon Corretto](https://aws.amazon.com/corretto/) 8 and 11.
...
[View Webinar](https://objectcomputing.com/products/micronaut/resources/micronaut-and-aws)

## Expand Your Expertise

The team regularly publishes [Micronaut Guides](https://guides.micronaut.io/), tutorials that enable developers to take their skills to the next level and get the most out of the framework.
