---
slug: 2020/04/07/micronaut-vs-quarkus-vs-spring-boot-performance-on-jdk-14
title: Micronaut vs Quarkus vs Spring Boot Performance on JDK 14
description: After the recent releases of Micronaut 2.0 M2 and JDK 14, I decided it would be a good time to see what the state of play is performance wise between the Micronaut framework, Quarkus, and Spring Boot on JDK 14 in 2020. Historically, we have encouraged users to make their own judgments, but recently some...
date: '2020-04-07T09:08:45'
modified: '2021-02-19T17:22:59'
sourceUrl: https://micronaut.io/2020/04/07/micronaut-vs-quarkus-vs-spring-boot-performance-on-jdk-14/
wordpressId: 2990
...
tags:
  ...
  - quarkus
  - springboot
href: /2020/04/07/micronaut-vs-quarkus-vs-spring-boot-performance-on-jdk-14/
---

After the recent releases of Micronaut 2.0 M2 and JDK 14, I decided it would be a good time to see what the state of play is performance wise between the Micronaut framework, Quarkus, and Spring Boot on JDK 14 in 2020.
...
We are all extremely proud of the Micronaut framework, and we know users have been happy with its powerful capabilities. We listen to feedback and work every day on making improvements that we hope will help even more people enhance their productivity and build faster, better apps. That said, I encourage all users to do their own testing and make their own judgments regarding which JVM framework they prefer.
