---
slug: 2020/04/30/introducing-micronaut-2-0-launch
title: Introducing Micronaut 2.0 Launch
description: With the release of Micronaut 2.0 M3, we have gone live with a brand new implementation of the Micronaut command line interface (CLI) and Micronaut Launch, an online tool for creating Micronaut applications. A CLI History When the Micronaut framework was first being developed, we knew we needed a tool to generate applications that allowed...
date: '2020-04-30T12:49:15'
modified: '2021-08-02T18:07:48'
sourceUrl: https://micronaut.io/2020/04/30/introducing-micronaut-2-0-launch/
wordpressId: 3000
...
The `micronaut-cli` module uses [GraalVM Native Image](https://www.graalvm.org/reference-manual/native-image/) to allow us to produce distributions of the CLI that target [Linux, MacOS, and Windows natively](https://github.com/micronaut-projects/micronaut-starter/releases/tag/v2.0.0.M3).
